            ...
            <div className="relative fr justify-between px-8 w-full h-[600px]">
                <div className="fc w-[550px] h-full justify-between self-end">
                    <div className="fc pt-[100px] gap-8">
                        ...
                        text-sky-950 text-[32px] font-medium font-['Roboto'] leading-[51.20px] z-20">Работаем для
                            здоровья и долголитея</h2>
                    </div>
                    <Link to={"contactForm"} offset={-190} smooth={true} duration={900}
                        ...
                        <p className="w-full self-center text-zinc-700 text-base font-normal font-['Roboto'] leading-relaxed">Нужны
                            информация, ответы?</p>
                        <button className="w-fit flex flex-row gap-2 whitespace-nowrap">
                            <h3 className="self-center text-neutral-900 text-lg font-bold font-['Roboto'] uppercase">давай
                                поговорим!</h3>
                            <svg
